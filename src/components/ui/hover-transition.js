        ...
        <>
          <Layer
            style={{
              ...
              filter: active ? "brightness(.82) saturate(.85)" : "none",
      ...
      >
        <div
          style={{
            ...
            filter: active ? "brightness(.88) saturate(.9)" : "none",
        ...
        <div
          ...
          style={{
            ...
            mixBlendMode: "screen",
            background:
              "radial-gradient(circle 220px at var(--hover-glare-x, 50%) var(--hover-glare-y, 50%), rgba(255,255,255,.35), rgba(255,255,255,.08) 48%, transparent 78%)",
